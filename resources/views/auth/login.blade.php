...
<body class="font-sans antialiased bg-slate-50" x-data="{ mobileMenuOpen: false }">
    ...
    <div class="min-h-[calc(100vh-80px)] flex relative z-10">
            ...
            <div class="max-w-lg text-white text-center">
                ...
                <div class="animate-fade-in-up">
                    ...
                    <p class="text-base opacity-90 leading-relaxed max-w-md mx-auto">
                        Platform digital untuk mengakses, membaca, dan mengelola koleksi perpustakaan kapan saja dan dimana saja
                    </p>
                </div>
               ...
               <!-- Mobile Logo & Title -->
                ...
                <div class="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl p-8 lg:p-10 animate-fade-in-up border border-white/50">
                    ...
                    <form method="POST" action="{{ route('login') }}" class="space-y-6">
                        ...
                        <div class="group">
                            <label for="user_cred" class="block text-sm font-semibold text-gray-700 mb-2">
                                Email / Username
                            </label>
                            <div class="relative">
                        ...
                        <div class="flex items-center justify-between text-sm">
                            <label for="remember_me" class="inline-flex items-center cursor-pointer group">
                                <input 
                                    ...
                                    name="remember">
                                <span class="ml-2 text-gray-600 group-hover:text-gray-800 transition-colors">
                                    Ingat saya
                                </span>
                            </label>

                            @if (Route::has('password.request'))
                                <a class="text-blue-600 hover:text-blue-800 font-medium transition-colors hover:underline" href="{{ route('password.request') }}">
                                    Lupa password?
                                </a>
                            @endif
                        </div>
                        ...
                        <!-- Login Button -->
                        <button type="submit" class="w-full bg-blue-600 text-white font-bold py-4 px-6 rounded-xl hover:bg-blue-700 focus:outline-none focus:ring-4 focus:ring-blue-500/50 transform transition-all duration-300 hover:scale-[1.02] shadow-lg active:scale-[0.98]">
                        ...
                        <div class="text-center pt-6 border-t border-gray-200">
                            <p class="text-sm text-gray-600">
                                Belum punya akun?
                                <a class="text-blue-600 hover:text-blue-800 font-semibold transition-colors hover:underline ml-1" href="{{ route('register') }}">
                                    Daftar sekarang
                                </a>
                            </p>
                        </div>
